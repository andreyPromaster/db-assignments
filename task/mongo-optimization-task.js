...
async function before(db) {
    ...
    await db.collection('opportunities').createIndex({"clientCriteria.versions.initiativeId": 1}); 
    await db.collection('opportunities').createIndex({"clientCriteria.value": 1});
